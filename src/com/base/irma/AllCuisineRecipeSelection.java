...
public class AllCuisineRecipeSelection extends MainActivity {
	

	//What type of recipes should be pulled from the database.
	String TypeToQuery = AllRecipeCuisineMainMenu.TypeSelected;   //TypeSelected in the previous menu
        ...
        RecipeList.setOnItemClickListener(new OnItemClickListener(){        	
                ...
                public void onItemClick(AdapterView<?> arg0, View v,int position, long arg3)
                {
                      ...
                      //Toast.makeText(getApplicationContext(), "Recipe Name/ID Selected : "+selectedRecipe  + " / " + SelectedRecipeIDNumber,   Toast.LENGTH_LONG).show();
            			...
            			Intent i = new Intent(AllCuisineRecipeSelection.this, ConfirmRecipeSelection.class);
            			startActivity(i);
